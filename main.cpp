...
int main(int argc, char* argv[]) {
    ...
    for (unsigned int currentMeas = firstMeas; currentMeas <= lastMeas; currentMeas++) {
        ...
        bool isNX = false;
        if ((baseLineString.find("NXVA") != std::string::npos) || (software_version.find("XA11") != std::string::npos) || (software_version.find("XA20") != std::string::npos) || (software_version.find("syngo MR XA") != std::string::npos) )
        {
            isNX = true;
        }
